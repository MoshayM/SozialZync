...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: '1 channel', ok: true },
      { text: 'AI Copilot (limited)', ok: true },
      { text: 'Shorts Studio (5 clips/mo)', ok: true },
      { text: 'Auto-publish', ok: false },
      { text: 'A/B Testing', ok: false },
      { text: 'Video Editor', ok: false },
      { text: 'Analytics', ok: false },
    ],
  },
  {
    name: 'Starter', price: '$19', period: 'per month', popular: false,
    description: 'For solo creators ready to publish consistently.',
    cta: 'Get started', href: '/register',
    features: [
      { text: '500 AI credits', ok: true },
      { text: '2 channels', ok: true },
      { text: 'Unlimited Copilot', ok: true },
      { text: 'Unlimited Shorts', ok: true },
      { text: 'Auto-publish approved content', ok: true },
      { text: 'A/B Testing', ok: false },
      { text: 'Video Editor', ok: false },
      { text: 'Analytics', ok: false },
    ],
  ...
  {
    name: 'Pro', price: '$49', period: 'per month', popular: true,
    description: 'For serious creators who want the full AI pipeline.',
    cta: 'Go Pro', href: '/register',
    features: [
      { text: '2,000 AI credits', ok: true },
      { text: '5 channels', ok: true },
      { text: 'Unlimited Copilot', ok: true },
      { text: 'Creative Studio (all tools)', ok: true },
      { text: 'Auto-publish + scheduling', ok: true },
      { text: 'A/B Testing', ok: true },
      { text: 'Autopilot AI pipeline', ok: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Team members & roles', ok: true },
      { text: 'Shared org wallet', ok: true },
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-xl border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2.5 shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#374151] rounded-lg" aria-label="SozialZynk home">
