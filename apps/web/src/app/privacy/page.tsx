...
Account Data: When you register, we collect your name, email address, and password (stored as a bcrypt hash). If you sign in via Google, Apple, or Facebook OAuth, we receive your name, email, and profile picture from that provider.

Usage Data: We log interactions with the platform — pages visited, features used, AI prompts submitted, and content generated. This data is used to improve our service and is never sold.

Content You Create: Scripts, captions, thumbnails, video outlines, and other AI-generated content you produce through Sozialzync are stored in your account and are yours to export or delete at any time.

Platform Connection Data: When you connect social accounts (YouTube, Instagram, TikTok, Facebook, LinkedIn, X), we store OAuth access tokens and refresh tokens to publish and retrieve analytics on your behalf. We request only the minimum scopes necessary for the features you use. You can revoke access at any time from your settings.
...
• Operate and deliver the Sozialzync service, including AI content generation, scheduling, and multi-platform publishing.
• Improve our AI models using anonymized, aggregated usage patterns. We do not use your identifiable content to train AI models without your explicit opt-in consent.
...
• Run compliance checks on content before it is published to ensure it meets platform policies and copyright requirements.
...
AI Providers: Prompts and content requests are sent to AI providers (in anonymized or pseudonymized form where possible) for generation. These providers are bound by data processing agreements that prohibit using your data for their own training.

Payment Processing: Stripe processes all payments. Your payment data is subject to Stripe's Privacy Policy.

Hosting & Infrastructure: We use cloud infrastructure providers (including Vercel and managed cloud services) that host our application. These providers have access only to the data necessary to run our systems and are bound by strict data processing agreements.
...
AI-generated content associated with your account is deleted within 30 days of account deletion. Anonymized, aggregated analytics derived from your usage may be retained indefinitely as they cannot be linked back to you.
...
• We maintain SOC 2 Type II compliance for our infrastructure and operational controls.
      ...
      <div style={{ background: 'linear-gradient(135deg, #4f2ec4 0%, #6D4AE0 55%, #7c5ae8 100%)' }} className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-white/65 text-base">
            Effective date: <strong className="text-white/85">July 25, 2026</strong>
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl p-6 mb-8 border border-gray-100 shadow-sm">
          <p className="text-gray-600 leading-relaxed">
            ...
            when you use our AI-powered social media platform. Please read it carefully.
          </p>
        </div>
