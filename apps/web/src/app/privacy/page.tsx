...
export const metadata: Metadata = {
  title: 'Privacy Policy · AI CreatorForce',
  description: 'How AI CreatorForce collects, uses, and protects your data.',
};
...
const SECTIONS = [
  {
    ...
    content: `We collect the following categories of information when you use AI CreatorForce:
...
Content You Create: Scripts, captions, thumbnails, AI-generated characters, avatar images, voice narrations, audio tracks, and other assets you produce through AI CreatorForce are stored in your account and are yours to export or delete at any time. Provenance metadata (model, timestamp, prompt hash) is stored with every AI-generated asset.
...
• Operate and deliver the AI CreatorForce service, including the full AI content pipeline: research, scripting, fact-checking, compliance checking, voice generation, image generation, and YouTube publishing.
...
Legal Requirements: We may disclose data if required by law, court order, or to protect the rights, safety, and property of AI CreatorForce, our users, or the public.
...
You may request deletion of specific data at any time by contacting privacy@aicreatorforce.com.`,
  },
  {
    id: 'your-rights',
    title: '5. Your Rights',
...
To exercise any of these rights, email privacy@aicreatorforce.com. We will respond within 30 days. Users in the European Economic Area (EEA), United Kingdom, and California have additional rights under GDPR, UK GDPR, and CCPA respectively.`,
  },
  {
    id: 'cookies',
    title: '6. Cookies & Tracking',
    content: `AI CreatorForce uses only functional cookies necessary to operate the service:
...
You can disable cookies in your browser settings, but this may prevent certain features from working correctly.`,
  },
  {
    ...
    content: `AI CreatorForce is intended for users aged 13 and older. We do not knowingly collect personal data from children under 13. If you believe a child under 13 has created an account, please contact us at privacy@aicreatorforce.com and we will promptly delete the account and associated data.
...
While we take extensive precautions, no system is completely secure. If you discover a security vulnerability, please report it responsibly to security@aicreatorforce.com.`,
  },
  {
    id: 'contact',
    title: '9. Contact Us',
...
Email: privacy@aicreatorforce.com
...
Your continued use of AI CreatorForce after the effective date of a revised policy constitutes your acceptance of the changes. If you do not agree to the updated policy, you may delete your account before the effective date.`,
  },
];
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl p-6 mb-8 border border-gray-100 shadow-sm">
          <p className="text-gray-600 leading-relaxed">
            AI CreatorForce (&ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;) is committed to protecting your privacy.
