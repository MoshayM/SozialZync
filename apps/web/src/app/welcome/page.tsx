        ...
        <section id="download" aria-label="Download the app" style={{background:'linear-gradient(160deg,#0e0924 0%,#130a3a 100%)'}}>
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
              ...
              {/* Web / PWA */}
              <a
                href="https://sozialzynk.vercel.app"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-5 py-3 rounded-2xl font-semibold text-white transition-all hover:opacity-90 hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
                style={{background:'linear-gradient(135deg,#374151,#1f2937)',border:'1px solid rgba(255,255,255,.15)',minWidth:200,boxShadow:'0 8px 24px -6px rgba(0,0,0,.5)'}}
              >
              ...
              {/* Google Play */}
              <a
                href="https://play.google.com/store/apps/details?id=app.sozialzynk"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-5 py-3 rounded-2xl font-semibold text-white transition-all hover:opacity-90 hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
                style={{background:'#1a1a1a',border:'1px solid rgba(255,255,255,.12)',minWidth:200,boxShadow:'0 8px 24px -6px rgba(0,0,0,.5)'}}
              >
                {/* Google Play icon */}
              ...
              {/* App Store */}
              <a
                href="https://apps.apple.com/app/sozialzynk/id6740000000"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-5 py-3 rounded-2xl font-semibold text-white transition-all hover:opacity-90 hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
                style={{background:'#1a1a1a',border:'1px solid rgba(255,255,255,.12)',minWidth:200,boxShadow:'0 8px 24px -6px rgba(0,0,0,.5)'}}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-12">
              ...
              <div className="rounded-2xl p-6 flex flex-col gap-4" style={{background:'rgba(255,255,255,.04)',border:'1px solid rgba(255,255,255,.1)'}}>
                ...
                <div>
                  ...
                  <p className="text-white/45 text-sm leading-relaxed">Download from Google Play or open in Chrome and tap <strong className="text-white/70">Add to Home Screen</strong> for instant install.</p>
                </div>
                <a
                  href="https://play.google.com/store/apps/details?id=app.sozialzynk"
                  target="_blank"
                  ...
                  style={{background:'rgba(52,168,83,.12)',border:'1px solid rgba(52,168,83,.28)',color:'rgba(134,239,172,.9)'}}
                >
              ...
              <div className="rounded-2xl p-6 flex flex-col gap-4" style={{background:'rgba(255,255,255,.04)',border:'1px solid rgba(255,255,255,.1)'}}>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="mt-auto flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all hover:opacity-90 w-full"
                  style={{background:'rgba(0,122,255,.1)',border:'1px solid rgba(0,122,255,.28)',color:'rgba(147,197,253,.9)'}}
                >
