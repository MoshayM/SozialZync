...
Every piece of content generated by the AI pipeline passes through the Compliance Intelligence Engine before it is made available for publishing. The Service is provided on a subscription basis. Features available to you depend on your subscription plan (Free, Pro, or Unlimited).`,
  },
  {
    id: 'accounts',
...
• Human approval is required before content is published to YouTube, unless you have explicitly enabled scheduled auto-publish and the item has already passed compliance.`,
  },
  {
    ...
    content: `The Ad Revenue Programme is available to creators on the Pro ($17/month) and Unlimited ($25/month) plans. By enabling ad revenue on a project, you agree that:

• SozialZynk will display your content on the public Browse page and count impressions.
• Revenue is distributed based on verified Browse page views, credited daily to your account.
• SozialZynk reserves the right to modify the payout rate, minimum threshold, or discontinue the programme with 30 days' notice.
• Content must comply with all Acceptable Use and Compliance Engine requirements to remain eligible for the programme. Disabling ad revenue or removing a project from Browse immediately suspends accrual.
...
You can revoke platform access at any time from your Sozialzynk account settings or from the connected platform's security settings.`,
  },
  {
    ...
    content: `Plans: SozialZynk offers three subscription tiers. Plan features and limits are described on our pricing page and may be updated from time to time with reasonable notice.
...
Billing: Paid subscriptions are billed in advance on a monthly basis through Stripe. By subscribing, you authorise SozialZynk to charge your payment method on a recurring basis.
