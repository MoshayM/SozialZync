...
@Module({
  ...
  controllers: [PlatformsController, InstagramOAuthController, FacebookOAuthController, TikTokOAuthController, LinkedInOAuthController, XOAuthController, PlatformMediaController],
